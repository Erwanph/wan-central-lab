    ...
    <main className="min-h-screen flex flex-col justify-between pt-16">
      <section className="relative bg-cover bg-center lg:h-[91vh] h-[50vh] flex items-center justify-center">
        ...
        <div className="container relative z-10 mx-auto text-center">
          <h1 className="lg:text-[80px] text-[30px] font-bold mb-2">Erwan's Central Laboratory</h1>
          <p className="lg:text-[27px] text-[17px] text-black max-w-2xl mx-auto">
            Welcome to Erwan's Central Laboratory! <br />Dive into our interactive virtual labs and explore various scientific and engineering concepts.
          </p>
        </div>
      </section>
        ...
        <div className="flex justify-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/simulation" className="bg-gray-100 text-black rounded-lg shadow-lg p-6 hover:bg-blue-700 hover:text-white transition">
              <div className="w-full h-40 bg-gray-300 rounded-t-lg mb-4"></div> {/* Placeholder for image */}
